...
var sc2 = class {
  ...
  applyChanges(t2, e, n) {
    ...
    if (this.$u = o, 0 !== i.length || u) {
      return {
        snapshot: new qu(this.query, t2.Uu, s, i, t2.mutatedKeys, 0 === o, u, false),
        zu: r
      };
    }
    return {
...
async function cc2(t2, e, n, s) {
  ...
  const i = await No(t2.localStore, e, true), r = new sc2(e, i.ji), o = r.Ku(i.documents), u = ps.createSynthesizedTargetChangeForCurrentChange(n, s && "Offline" !== t2.onlineState), c = r.applyChanges(o, t2.isPrimaryClient, u);
  Tc2(t2, n, c.zu);
...
function dl(t2) {
  ...
  return oa2(n, t2._key).then((n2) => new kh(e, s, t2._key, n2, new Nh(null !== n2 && n2.hasLocalMutations, true), t2.converter));
}
function _l(t2) {
  t2 = Ia2(t2, ba2);
  const e = Ia2(t2.firestore, Fa2);
...
* limitations under the License.
*/
//# sourceMappingURL=chunk-DTITJSTJ.js.map
